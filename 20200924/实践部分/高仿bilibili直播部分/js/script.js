$(function () {
  ...
  $game_item.hover(
    function () {
      $gameImg.attr(
        "style",
        "background-image: url(images/cont/" + urlArr[$(this).index()] + ")"
      );
    },
    function () {
      $gameImg.attr("style", "");
  ...
  var $sideBar_btn = $(".sideBar-list")
    .find("a")
    .not($(".sideBar-list").find("a").last());
  ...
  $sideBar_btn.click(function () {
    ...
    $(document.body)
      .stop()
      .animate({ scrollTop: $mainCont_item.eq(index).offset().top });
